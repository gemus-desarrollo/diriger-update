...
(function($) {
    ...
    function clikcToEdit(evt, tarNode) {
        var txt = [],
            table = evt,
            submit = '<button type="button" class="btn btn-primary btn-sm editable-submit"><i class="fa fa-hand-peace"></i></button>',
            cancel = '<button type="button" class="btn btn-default btn-sm editable-cancel"><i class="fa fa-eraser"></i></button>';
            ...
            table.columns.forEach(function(column, i) {
                ...
                switch (column.editable) {
                    case 'input':
                        ...
                        break;
                    case 'select':
                        var select = $('<select id="' + column.field + '">'),
