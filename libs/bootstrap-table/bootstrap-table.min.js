...
! function(a) {
    ...
    o.DEFAULTS = {
        ...
        iconsPrefix: "fa",
        icons: { paginationSwitchDown: "fa-chevron-down icon-chevron-down", paginationSwitchUp: "fa-chevron-up icon-chevron-up", refresh: "fa-refresh icon-refresh", toggle: "fa-list-alt icon-list-alt", columns: "glyphicon-th icon-th", detailOpen: "fa-plus icon-plus", detailClose: "fa-minus icon-minus" },
        customSearch: a.noop,
        customSort: a.noop,
