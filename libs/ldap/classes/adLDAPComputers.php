...
class adLDAPComputers {
    ...
    */
     ...
     *
     *
     Add these code to your .php to call the functions.

        $attributes=array(
        "cn" =>"PC3",
        "container" =>array("Clients","Worker","Windows"),
        "name"=>"PC3"
        );

        $result = $adldap->computer()->create($attributes);
        $adldap->computer()->delete("PC1");
     *
     */
