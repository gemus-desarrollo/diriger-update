...
class adLDAP {
    ...
    const ADLDAP_SECURITY_NO_LOCAL_GROUP = 536870912;
    const ADLDAP_DISTRIBUTION_NO_LOCAL_GROUP = 536870913;
    ...
    * @var string
    */   
	protected $accountSuffix = "@movitel.co.cu";
    ...
    * @var string
    */
	protected $baseDn = "DC=movitel,DC=co,DC=cu";
    ...
    * @var array
    */
    protected $domainControllers = array('idc2.movitel.co.cu','nsh1.ch.movitel.co.cu'/*,'dcoc.oc.movitel.co.cu','dcct.ct.movitel.co.cu','dcot.ot.movitel.co.cu'*/);
