...
$_root_ldap= "";
if (@file_exists('libs/ldap/src/Classes/AbstractAdldapBase.php') ) $_root_ldap= "";
elseif (@file_exists('../libs/ldap/src/Classes/AbstractAdldapBase.php') ) $_root_ldap= "../";   
elseif (@file_exists('../../libs/ldap/src/Classes/AbstractAdldapBase.php') ) $_root_ldap= "../../";  

require_once($_root_ldap.'libs/ldap/src/Classes/AbstractAdldapBase.php');
require_once($_root_ldap.'libs/ldap/src/Classes/AbstractAdldapQueryable.php');
require_once($_root_ldap.'libs/ldap/src/Classes/AdldapComputers.php');
require_once($_root_ldap.'libs/ldap/src/Classes/AdldapContacts.php');
require_once($_root_ldap.'libs/ldap/src/Classes/AdldapExchange.php');
require_once($_root_ldap.'libs/ldap/src/Classes/AdldapFolders.php');
require_once($_root_ldap.'libs/ldap/src/Classes/AdldapGroups.php');
require_once($_root_ldap.'libs/ldap/src/Classes/AdldapSearch.php');
require_once($_root_ldap.'libs/ldap/src/Classes/AdldapUsers.php');
require_once($_root_ldap.'libs/ldap/src/Classes/AdldapUtils.php');

require_once($_root_ldap.'libs/ldap/src/Exceptions/AdldapException.php');

require_once($_root_ldap.'libs/ldap/src/Exceptions/InvalidQueryOperator.php');
require_once($_root_ldap.'libs/ldap/src/Exceptions/PasswordPolicyException.php');
require_once($_root_ldap.'libs/ldap/src/Exceptions/WrongPasswordException.php');

require_once($_root_ldap.'libs/ldap/src/Interfaces/ConnectionInterface.php');

require_once($_root_ldap.'libs/ldap/src/Objects/AbstractObject.php');
require_once($_root_ldap.'libs/ldap/src/Objects/AccountControl.php');
require_once($_root_ldap.'libs/ldap/src/Objects/Configuration.php');
require_once($_root_ldap.'libs/ldap/src/Objects/Contact.php');
require_once($_root_ldap.'libs/ldap/src/Objects/Folder.php');
require_once($_root_ldap.'libs/ldap/src/Objects/Group.php');
require_once($_root_ldap.'libs/ldap/src/Objects/Mailbox.php');
require_once($_root_ldap.'libs/ldap/src/Objects/Schema.php');
require_once($_root_ldap.'libs/ldap/src/Objects/User.php');

require_once($_root_ldap.'libs/ldap/src/Objects/Ldap/Entry.php');
require_once($_root_ldap.'libs/ldap/src/Objects/Ldap/Schema.php');

require_once($_root_ldap.'libs/ldap/src/Query/Builder.php');
require_once($_root_ldap.'libs/ldap/src/Query/Operator.php');

require_once($_root_ldap.'libs/ldap/src/Traits/LdapFunctionSupportTrait.php');

require_once($_root_ldap.'libs/ldap/src/Connections/Ldap.php');
