...
$array= array();
$result_reg= $obj->listar_reg_real($array);
$n= 0;
                ...
                <table id="table" class="table table-striped" 
                    ...
                    ?>
                        <tr>			    				
                            ...
                            <td>
                                <?= ($row['chk_cumulative'] && !is_null($row['acumulado_corte'])) ?  "{$row['acumulado_corte']}<br/>" : null?>
                                <?=odbc2date($row['reg_date'])?>
                            </td>                            
                            <td>
                                <?= $row['acumulado_real'] ?>
                            </td>                            
                            <td>
                                <?php if (boolean($row['chk_cumulative'])) { ?>
