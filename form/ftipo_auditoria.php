...
$url_page = "../form/ftipo_auditoria.php?signal=$signal&action=$action&menu=tipo_auditoria";
...
<head>
    ...
    <title>TIPO DE ACCION DE CONTROL</title>
    ...
    function validar() {
        if (!Entrada($('#numero').val())) {
            ...
            alert('Especifique el número del tipo de auditoria');
            return;
        }

        if (!Entrada($('#nombre').val())) {
            $('#nombre').focus(focusin($('#nombre')));
            alert('Introduzca el nombre del tipo de acción de control');
            return;
        }
        ...
        $('#_submit').hide();
        $('#_submited').show();
        document.forms[0].action = '../php/tipo.interface.php?menu=tipo_auditoria';
    ...
    <div class="app-body form">
        <div class="container">
            <div class="card card-primary">
                <div class="card-header">TIPO DE ACCIONES DE CONTROL</div>
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="javascript:validar()" method="POST">
                        ...
                        <input type="hidden" id="menu" name="menu" value="tipo_auditoria" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="descripcion" rows="8" id="descripcion"
